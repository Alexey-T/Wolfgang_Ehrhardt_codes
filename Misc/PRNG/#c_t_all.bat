...
rem compile batch file for t_all_r, checks for crypto sources
rem pause after each compiler if %1 not empty
rem call self on low env space condition
rem (c) 2003-2012 W.Ehrhardt
...
if not exist aes_encr.pas goto nocrypt
if not exist salsa20.pas  goto nocrypt
set OPT=
