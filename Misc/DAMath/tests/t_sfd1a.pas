...
begin
  ...
  testrel(15, NE1, y, f, cnt,failed);    {ARM}
  ...
  testrel(22, NE1, y, f, cnt,failed);   {ARM}
...
begin
  ...
  testrel(16, NE1, y, f, cnt,failed);   {!!64-bit}
  ...
  testrel(25, NEN+1, y, f, cnt,failed);  {+1 for ARM}
  ...
  y := polygamma(50, x);
  testrel(70, NEN1, y, f, cnt,failed);

  x := -0.5-ldexpd(1,-12);
  f := -0.3411319768828644233e79;
  y := polygamma(50, x);
  testrel(71, NEN1, y, f, cnt,failed);
  ...
  y := polygamma(10, x);
  testrel(74, NEN1, y, f, cnt,failed);
  ...
  y := polygamma(20, x);
  testrel(76, NEN1, y, f, cnt,failed);

  {Adjust for double}
  x := -0.5-ldexpd(1,-50);
  f := -0.1240895002633085452e68;
  y := polygamma(50, x); {cot poly}
  testrel(77, NEN1, y, f, cnt,failed);

  x := -0.5-ldexpd(1,-50);
  f := -0.7134331491889076513e109;
  y := polygamma(70, x);  {cot series}
  testrel(78, NEN1, y, f, cnt,failed);

  x := -0.5+ldexpd(1,-50);
  f := 0.7134331491889076513e109;
  y := polygamma(70, x);
  testrel(79, NEN1, y, f, cnt,failed);
