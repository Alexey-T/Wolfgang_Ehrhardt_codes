{Part 4a of regression test for SPECFUND unit  (c) 2010-2018  W.Ehrhardt}
...
begin
  ...
  testrel(17, NE+1, y, f, cnt,failed);   {+1 for CPUARM}
...
begin
  ...
  testrel(26, NE+1, y, f, cnt,failed);  {+1 for ARM}
...
begin
  ...
  testrel(16, NE+2, y, f, cnt,failed);   {+2 for ARM}
...
begin
  ...
  testrel(3, NE1, y, f, cnt,failed);   {ARM}

  y := e1s(1);
  f := 0.5963473623231940743;
  testrel(4, NE1, y, f, cnt,failed);   {ARM}
  ...
  testrel(14, NE1, y, f, cnt,failed);      {ARM}
  ...
  testrel(16, NE1, y, f, cnt,failed);      {ARM}
...
begin
  ...
  testrel(9, NE+1, y, f, cnt,failed);     {ARM}
  ...
  y := eis(100);
  f := 0.1010206252774835711e-1;
  testrel(12, NE+1, y, f, cnt,failed);    {ARM}
...
begin
  ...
  y := expint3(x);
  testrel(22, NE1, y, t, cnt,failed);

  x := 1e-3;
  t := 0.99999999975e-3;
  y := expint3(x);
  testrel(23, NE1, y, t, cnt,failed);
...
begin
  ...
  testrel(8, NE+1, y, f, cnt,failed);     {ARM}
