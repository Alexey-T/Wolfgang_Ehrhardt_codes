{Part 9 of regression test for SPECFUND unit  (c) 2013-2018  W.Ehrhardt}
...
{$endif}
  ...
  testrel(61, NE1, y, f, cnt,failed);

  y := hyperg_1F1(-10, -100, -1.0);
  {f := 0.90442397250313899}
...
{$ifdef FPC}
  testrel(90, NE2, y, f, cnt,failed);    {NE2 for FPC/SSE2}
{$else}
...
{$endif}
  ...
  testrel(103, NE3, y, f, cnt,failed);
...
{$else}
  testrel(104, NE4, y, f, cnt,failed);
{$endif}

  y := hyperg_1F1(-100.5, -102.1, 10);
  f := 18678.558725244365016;
{$ifdef FPC}
  testrel(105, NE3, y, f, cnt,failed);
{$else}
...
{$endif}
  ...
  testrel(115, NE2, y, f, cnt,failed);
  ...
  testrel(122, NE2, y, f, cnt,failed);
...
{$else}
  testrel(128, NE2, y, f, cnt,failed);
{$endif}
  ...
  testrel(132, NE1, y, f, cnt,failed);
  ...
  testrel(135, NE2, y, f, cnt,failed);
  ...
  testrel(142, NE1, y, f, cnt,failed);
  ...
  testrel(146, NE2, y, f, cnt,failed);
  ...
  testrel(148, NE1, y, f, cnt,failed);

  y := hyperg_1F1(-0.125,-0.25,5);
  f := 98.89577758359759834;
  testrel(149, NE1, y, f, cnt,failed);
  ...
  testrel(151, NE1, y, f, cnt,failed);
  ...
  testrel(154, NE1, y, f, cnt,failed);
...
{$ifdef BIT64}
  testrel(162, NE3, y, f, cnt,failed);
{$else}
...
{$endif}
  ...
  testrel(165, NE2, y, f, cnt,failed);

  {very small a and b}
  y := hyperg_1F1(2e-16, 1e-16, -1.0);
  f := -0.2642411176571152945;
...
{$ifdef BIT64}
  ...
  testrele(38, 1.5e-14, y, f, cnt,failed);
{$else}
  y := hyperg_2F1(9, 9, -8.5, -0.99);
  f := -0.885646260657534448e1;
  ...
  y := hyperg_2F1(9, 9, -100.5, 0.99);
  f := -3.186778061428268980e+262;
  testrele(38, 8e-14, y, f, cnt,failed);
{$endif}
  ...
  testrele(70, 4600, y, f, cnt,failed);   {!!!!!!!!!!!!!!}
  ...
  testrel(76, 2200, y, f, cnt,failed);      {!!!!!!!!!!!!!!}

  y := hyperg_2F1(-36,6.25,-40,-2);
  f := 0.1512306062973965135e12;
  testrel(77, NE1, y, f, cnt,failed);
  ...
  testrel(125, NE2, y, f, cnt,failed);
