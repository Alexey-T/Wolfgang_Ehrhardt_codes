{Part 6 of regression test for SPECFUND unit  (c) 2010-2013  W.Ehrhardt}
...
begin
  ...
  testrel(8, 16, y, f, cnt,failed);   {!!!64-bit}
...
begin
  ...
  testabs(7, NA2, y, f, cnt,failed);

  x := 100.0;
  y := bessel_y1(x);
  f := -0.20372312002759793305e-1;
  testabs(8, NA2, y, f, cnt,failed);
...
begin
  ...
  testrel(12, 4*NE, y, f, cnt,failed);  {!!!64-bit}
  ...
  y := bessel_yv(2.25, ldexpd(1,-450));
  f := -0.10648031421919560336e306;
  testrel(16, NE3, y, f, cnt,failed);   {extreme case}
  ...
  {Near overflow cases}
  y := bessel_yv(172.5, 2.0625);
  f := -0.2579209314686179e308;
  testrel(24, NE2, y, f, cnt,failed);

  y := bessel_yv(170.9, 2);
  f := -0.1390044108907301e307;
...
begin
  ...
  testrel(8, 2*NE, y, f, cnt,failed);   {!!!64-bit}
  ...
  testrel(29, 2*NE, y, f, cnt,failed);      {!!!64-bit}
...
begin
  ...
  testrel(10, 2*NE, y, f, cnt,failed);  {!!!64-bit}

  y := bessel_ive(-144794/1024, 100);
  f := 0.76867072293271481512e-40;
  testrel(11, 2*NE, y, f, cnt,failed);  {!!!64-bit}
...
begin
  ...
  y := bessel_kv(2.25, ldexpd(1.0, -30));
  ...
  testrel(27, 2*NE, y, f, cnt,failed);     {!!!64-bit}
...
{$endif}
  ...
  testrel(23, NE, y, f, cnt,failed);  {600: SSE, 10: x87}
...
begin
  ...
  y := bessel_k0_int(5.0);
  testrel(9, NE2, y, f, cnt,failed);     {NE2: x87}

  f := 0.15696345532693743714e1;
  y := bessel_k0_int(6.0);
  testrel(10, NE2, y, f, cnt,failed);    {NE2: SSE}
