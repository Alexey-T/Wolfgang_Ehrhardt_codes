{Part 3d of regression test for SPECFUND unit  (c) 2014-2015  W.Ehrhardt}
...
{$endif}
  ...
  testrel(14, NE1+1, y, f, cnt,failed); {+1 for ARM}
...
begin
  ...
  testrel(11, NE+1, y, f, cnt,failed);  {+1 for ARM}
...
begin
  ...
  testrel(8, NE1+2, y, f, cnt,failed);  {+2 for ARM}

  y := wald_inv(a,b,0.9990234375);   {Needs restart}
  f := 8.39143866628992312;
  testrel(9, NE2a, y, f, cnt,failed);
  ...
  testrel(16, NE+4, y, f, cnt,failed); {+4 for ARM}
  ...
  testrel(18, NE2a, y, f, cnt,failed);
  ...
  testrel(26, NE1+2, y, f, cnt,failed);  {+2 for ARM}
...
begin
  ...
  testrel(30, NE+1, y, f, cnt,failed);   {+1 for ARM}
...
begin
  ...
  testrel(2, NE+1, y, f, cnt,failed);  {+1 CPUARM}
  ...
  testrel(11, NE+1, y, f, cnt,failed);  {+1 CPUARM}
  ...
  testrel(19, NE+1, y, f, cnt,failed);  {+1 CPUARM}
...
begin
  ...
  testrel(6, NE+1, y, f, cnt,failed);  {+1 CPUARM}
  ...
  testrel(20, NE+1, y, f, cnt,failed);  {+1 CPUARM}
  ...
  testrel(27, NE+1, y, f, cnt,failed);  {+1 CPUARM}
