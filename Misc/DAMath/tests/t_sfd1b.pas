{Part 1b of regression test for SPECFUND unit  (c) 2010-2018  W.Ehrhardt}
...
begin
  ...
  incgamma(a,x,cp,cq);
  testrel(59, NE2, cp, p, cnt,failed);
  ...
  incgamma(a,x,cp,cq);
  testrel(75, NE2, cp, p, cnt,failed);
  ...
  incgamma(a,x,cp,cq);
  testrele(79, NE2, cp, p, cnt,failed);      {!!!!!!!!}
  testrele(80, NE2, cq, q, cnt,failed);      {!!!!!!!!}
  ...
  testrel(82, NE2, cq, q, cnt,failed);
  ...
  testrel(88, NE3, cq, q, cnt,failed);
  ...
  incgamma(a,x,cp,cq);
  testrel(89,100, cp, p, cnt,failed);      {!!!!!!!!}
  ...
  testrel(126, NE2, cq, q, cnt,failed);
  ...
  testrel(128, NE2, cq, q, cnt,failed);
  ...
  testrel(130, NE3, cq, q, cnt,failed);
...
begin
  ...
  testrel(69, NEx, y, f, cnt,failed);

  y := igamma(5000,55000);
  f := 8.278720754962823876E-190;
  testrel(70, NEx, y, f, cnt,failed);

  y := igamma(1700,16500);
  f := 0.4936956875959810692;
  testrel(71, NEx, y, f, cnt,failed);
...
begin
  ...
  testrel(26, 2*NE, y, f, cnt,failed);
  ...
  testrel(38, NE+1, y, f, cnt,failed);  {+1 for ARM}
...
const
  ...
  NE1 = 8;
  NE2 = 50;
  NE2a = 1100;          {Pure Double/AMD, 50 is OK with I387}
  NA  = 16;
begin
  cnt := 0;
  failed := 0;
  ...
  testrel(28, 2*NE, y, f, cnt,failed);
  ...
  testrel(48, NE+1, y, f, cnt,failed); {+1 for ARM}
...
{$endif}
  ...
  {-----------  extreme cases / loss of acc -----------------}
  y := igammat(-179.5,49.3204638);
  f := 0.218539701722216035116936150478e298;
  testrele(68, 4e-7, y, f, cnt,failed);

  {with debug warning: !*** sfd_git: loss of accuracy'}
  y := igammat(-179.5,49.32046374);
  f := -0.195725085272013939709021858740e296;
  testrele(69, 6e-5, y, f, cnt,failed);
