{Part 3b of regression test for SPECFUN unit  (c) 2011+  W.Ehrhardt}
...
begin
  ...
  y := laplace_inv(a, b, 1-ldexp(1,-20));
  f := 26.33959286127792176;
  testrel(9, NE, y, f, cnt,failed);
...
begin
  ...
  y := logistic_inv(a, b, 1-ldexp(1,-20));
  f := 13.86294265752413503;
  testrel(9, NE, y, f, cnt,failed);
...
begin
  ...
  y := lognormal_inv(a, b, ldexp(1,-20));
  ...
  testrel(7, 3, y, f, cnt,failed);     {!!!}

  y := lognormal_inv(a, b, 0.9990234375);
  f := 769.6251801436839498;
  testrel(8, NE, y, f, cnt,failed);

  y := lognormal_inv(a, b, 1-ldexp(1,-20));
...
begin
  ...
  y := uniform_inv(a, b, 1-ldexp(1,-20));
...
begin
  ...
  y := weibull_inv(a, b, 1-ldexp(1,-20));
