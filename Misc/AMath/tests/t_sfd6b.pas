{Part 6b of regression test for SPECFUN unit  (c) 2018  W.Ehrhardt}
...
begin
  ...
  testrel(39, NE1, fc, f, cnt,failed);
  ...
  CoulombFFp(0, 100, 1, fc,fcp, ierr);
  f := 0.8999367996930662705e-125;
  testrel(49, NE, fc, f, cnt,failed);
  f := 0.1292746745757069321e-123;
  testrel(50, NE, fcp, f, cnt,failed);
  ...
  testrel(54, NE2, fcp, f, cnt,failed);
  {---- end GSL ----}
  ...
  testrel(71, NE, fc, f, cnt,failed);
  f := 0.7373136842030188765e-25;
  testrel(72, NE, fcp, f, cnt,failed);
  ...
  testrel(86, NE, fcp, f, cnt,failed);

  CoulombFFp(0,1,20, fc,fcp, ierr);
  f := -0.3292255362657539884;
  testrel(87, NE, fc, f, cnt,failed);
  ...
  {extended only}
  CoulombFFp(0, 500, 0.025, fc,fcp, ierr);
  f := 0.4853159323960411709e-679;
  testrel(96, NE, fc, f, cnt,failed);
  f := 0.1023214917134743202e-676;
  testrel(97, NE, fcp, f, cnt,failed);
...
begin
  ...
  testrel(3, NE, gc, f, cnt,failed);
  f := -3.392874637658605463;
  testrel(4, NE, gcp, f, cnt,failed);
  ...
  testrel(20, NE, gcp, f, cnt,failed);
  ...
  testrel(41, NE, gc, f, cnt,failed);
  f := -3.549156038719924236;
  testrel(42, NE, gcp, f, cnt,failed);
