{Part 2b of regression test for SPECFUN unit  (c) 2013  W.Ehrhardt}
...
begin
  ...
  testrel(23, NE, y, f, cnt,failed);  {near boundary}
...
begin
  ...
  k := 0.5;
  x := 0.86602783203125; {~sqrt(3)/2;}
  y := jacobi_arcds(x, k);
  f := 1.683382278521946864;
  testrel(1, NE, y, f, cnt,failed);
