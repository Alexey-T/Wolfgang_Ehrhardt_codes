{Part 2a of regression test for SPECFUND unit  (c) 2010-2018  W.Ehrhardt}
...
begin
  cnt := 0;
  failed := 0;
  writeln('Function: ','neville_theta');
  y := ntheta_s(0,0.5);
  f := 0;
  testrel(1, NE, y, f, cnt,failed);
