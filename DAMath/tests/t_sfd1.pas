{Part 1 of regression test for SPECFUND unit  (c) 2010-2018  W.Ehrhardt}
...
begin
  ...
  testrel( 7, 400, y, f, cnt,failed);   {!!! uses exp(lngamma) to prevent overflow}
...
begin
  ...
  testrel( 1, NE+1, y, f, cnt,failed); {+1 for ARM}
...
begin
  ...
  testrel(n, NE+1, y, f, cnt,failed);  {+1 for ARM}
...
begin
  ...
  y := gamma_ratio(1-ldexpd(1,-20), 1+ldexpd(1,-20));
  f := 1.000001100952115336;
  testrel(16, NE, y, f, cnt,failed);

  y := gamma_ratio(8-ldexpd(1,-20), 8+ldexpd(1,-20));
...
begin
  ...
  testrel(21, NE1, y, f, cnt,failed);   {ARM}
