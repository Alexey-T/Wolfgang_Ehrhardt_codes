{Part 2b of regression test for SPECFUNX unit  (c) 2013  W.Ehrhardt}
...
procedure test_jacobi_arcsnx;
procedure test_jacobi_arccnx;
procedure test_jacobi_arcdnx;

procedure test_jacobi_arcscx;
procedure test_jacobi_arccsx;
procedure test_jacobi_arcncx;
procedure test_jacobi_arcnsx;
procedure test_jacobi_arcndx;
procedure test_jacobi_arccdx;
procedure test_jacobi_arcdcx;
procedure test_jacobi_arcsdx;
procedure test_jacobi_arcdsx;
...
begin
  cnt := 0;
  failed := 0;
  writeln('Function: ','jacobi_arcsnx');
  ...
  x := 1-ldexp(1,-30);
  k := 1-ldexp(1,-20);
  f := 7.939951215553752532;
  y := jacobi_arcsnx(x,k);
  testrel(18, NE, y, f, cnt,failed);

  x := 1-ldexp(1,-30);
  k := 1+ldexp(1,-32);
  f := 10.81311776133755920;
  y := jacobi_arcsnx(x,k);
  ...
  y := jacobi_arcsnx(0.25, 4);
  f := 0.3990605555329458775;
  testrel(43, NE, y, f, cnt,failed);

  y := jacobi_arcsnx(0.2, 5);
  f := 0.3173735694908332475;
...
begin
  cnt := 0;
  failed := 0;
  writeln('Function: ','jacobi_arccnx');
  ...
  k := 1-ldexp(1,-30);
  x := 0;
  f := 11.4369284843320018031297335270;
  y := jacobi_arccnx(x,k);
  testrel(19, NE, y, f, cnt,failed);

  x := ldexp(1,-30);
  f := 11.43690690514556088;
  y := jacobi_arccnx(x,k);
  testrel(20, NE3, y, f, cnt,failed);

  x := -ldexp(1,-30);
  f := 11.43695006351844273;
  y := jacobi_arccnx(x,k);
  ...
  y := jacobi_arccnx(1-1/1024, k);
  f := 0.0442013679399762574185108812419;
  testrel(28, NE, y, f, cnt,failed);

  y := jacobi_arccnx(0.75, k);
  f := 0.737672368302886292896633710301;
  testrel(29, NE, y, f, cnt,failed);

  y := jacobi_arccnx(0.5, k);
  f := 1.089550670051885409;
  testrel(30, NE, y, f, cnt,failed);

  y := jacobi_arccnx(0.25, k);
  f := 1.394992625369530698;
  testrel(31, NE, y, f, cnt,failed);

  y := jacobi_arccnx(0.03125, k);
  ...
  k := 2;
  {x = sqrt(3)/2..1}
  y := jacobi_arccnx(0.8662109375, k);
  f := 0.8221715501634522648;
  testrel(39, NE2, y, f, cnt,failed);

  y := jacobi_arccnx(0.875, k);
  f := 0.6974963126847653491;
  testrel(40, NE, y, f, cnt,failed);

  y := jacobi_arccnx(0.90625, k);
  f := 0.5227981471475147268;
  testrel(41, NE, y, f, cnt,failed);

  y := jacobi_arccnx(0.96875, k);
  f := 0.2623795549460648467;
  testrel(42, NE, y, f, cnt,failed);

  y := jacobi_arccnx(0.9921875, k);
...
begin
  cnt := 0;
  failed := 0;
  writeln('Function: ','jacobi_arcdnx');

  {-----------------------------------------}
  k := 1.5;
  x := ldexp(1,-20);
  f := 1.206444143998819044;
  y := jacobi_arcdnx(x,k);
  testrel(1, NE, y, f, cnt,failed);
  ...
  k := 1+ldexp(1,-30);
  x := ldexp(1,-30);
  f := 11.43690689495976254;
  y := jacobi_arcdnx(x,k);
  testrel(18, NE2, y, f, cnt,failed);

  k := 1-ldexp(1,-30);
  x := ldexp(3,-14);
  f := 9.312782926000348540;
  y := jacobi_arcdnx(x,k);
  ...
  k := 0.5;
  {x = kc .. 1 = sqrt(3)/2 .. }
  y := jacobi_arcdnx(0.8662109375, k);
  f := 1.644343100326904530;
  testrel(20, NE, y, f, cnt,failed);


  y := jacobi_arcdnx(0.875,0.5);
  f := 1.394992625369530698;
  testrel(21, NE, y, f, cnt,failed);

  y := jacobi_arcdnx(0.90625, k);
  f := 1.045596294295029454;
  testrel(22, NE, y, f, cnt,failed);

  y := jacobi_arcdnx(0.96875, k);
  ...
  k := 2;
  y := jacobi_arcdnx(-0.9990234375, k);
  f := 1.663649670842607914;
  testrel(25, NE, y, f, cnt,failed);

  y := jacobi_arcdnx(-0.875, k);
  f := 1.430444414968407738;
  testrel(26, NE, y, f, cnt,failed);

  y := jacobi_arcdnx(-0.25, k);
  ...
  y := jacobi_arcdnx(-0.875, 5);
  f := 0.5335108266509599867;
  testrel(33, NE, y, f, cnt,failed);

  y := jacobi_arcdnx(-0.75, 3);
...
begin
  cnt := 0;
  failed := 0;
  writeln('Function: ','jacobi_arcscx');
  ...
  y := jacobi_arcscx(-0.0625,k);
  f := -0.6242893947277133946e-1;
  testrel(2, NE, y, f, cnt,failed);

  y := jacobi_arcscx(0.125,k);
  f := 0.1244350127068800583;
  testrel(3, NE, y, f, cnt,failed);

  y := jacobi_arcscx(-0.5,k);
...
{$endif}
  ...
  y := jacobi_arcscx(0.1,10);
  f := 0.1474576468586894999;
  testrel(21, NE, y, f, cnt,failed);

  y := jacobi_arcscx(1/128,100);
  f := 0.8966378520558796833e-2;
  testrel(22, NE, y, f, cnt,failed);

  y := jacobi_arcscx(1e10,1);
  f := 23.71899811050040215;
  testrel(23, NE, y, f, cnt,failed);

  y := jacobi_arcscx(42,0);
...
begin
  cnt := 0;
  failed := 0;
  writeln('Function: ','jacobi_arccsx');
  ...
  y := jacobi_arccsx(1/1024, k);
  f := 1.684622717986295370;
  testrel(2, NE, y, f, cnt,failed);

  y := jacobi_arccsx(0.5, k);
  f := 1.156321727760690225;
  testrel(3, NE, y, f, cnt,failed);
  ...
  y := jacobi_arccsx(1024, k);
  f := 2*0.4882811141821932303e-3;
  testrel(7, NE, y, f, cnt,failed);

  y := jacobi_arccsx(1e6, k);
  f := 9.999999999997083333e-7;
  testrel(8, NE, y, f, cnt,failed);

  y := jacobi_arccsx(1e10, k);
  f := 1e-10;
  testrel(9, NE, y, f, cnt,failed);
  ...
  {--------}
  k := 2;
  y := jacobi_arccsx(sqrt(3), k);
  f := 0.8428751774062980214;
  testrel(11, NE, y, f, cnt,failed);

  y := jacobi_arccsx(1.75, k);
  ...
  y := jacobi_arccsx(0.125,0);
  f := 1.446441332248135184;
  testrel(22, NE, y, f, cnt,failed);

  y := jacobi_arccsx(0.125,1/1024);
...
begin
  cnt := 0;
  failed := 0;
  writeln('Function: ','jacobi_arcncx');
  ...
  y := jacobi_arcncx(1.015625, k);
  f := 0.1758624151346494556;
  testrel(2, NE, y, f, cnt,failed);

  y := jacobi_arcncx(1.125, k);
  ...
  y := jacobi_arcncx(16, k);
  f := 1.613550174333460224;
  testrel(6, NE, y, f, cnt,failed);

  y := jacobi_arcncx(1e6, k);
  ...
  y := jacobi_arcncx(1.15, k);
  f := 0.7521171338476383294;
  testrel(13, NE, y, f, cnt,failed);
...
begin
  cnt := 0;
  failed := 0;
  writeln('Function: ','jacobi_arcnsx');
  ...
  y := jacobi_arcnsx(-1.0625, k);
  f := -1.290246106568424218;
  testrel(2, NE, y, f, cnt,failed);

  y := jacobi_arcnsx(1.125, k);
  ...
  k := 1+1/1024;
  y := jacobi_arcnsx(1.001953125, k);
  f := 3.622903330202696377;
  testrel(18, NE, y, f, cnt,failed);
...
begin
  cnt := 0;
  failed := 0;
  writeln('Function: ','jacobi_arcndx');
  ...
  y := jacobi_arcndx(1+1/1024, k);
  f := 0.0884677140647019265;
  testrel(2, NE, y, f, cnt,failed);

  y := jacobi_arcndx(1.015625, k);
  f := 0.3588809717652129774;
  testrel(3, NE, y, f, cnt,failed);

  y := jacobi_arcndx(1.0625, k);
  f := 0.7582115124496915987;
  testrel(4, NE, y, f, cnt,failed);

  y := jacobi_arcndx(1.125, k);
  f := 1.214034387269042046;
  testrel(5, NE, y, f, cnt,failed);

  y := jacobi_arcndx(1.15, k);
  f := 1.5042342676952766587;
  testrel(6, NE, y, f, cnt,failed);
  ...
  y := jacobi_arcndx(16, k);
  f := 0.8067750871667301122;
  testrel(13, NE, y, f, cnt,failed);

  y := jacobi_arcndx(1024, k);
  f := 0.8423113587242981223;
  testrel(14, NE, y, f, cnt,failed);

  y := jacobi_arcndx(1e6, k);
  ...
  k := 0.984375;
  y := jacobi_arcndx(x,k);
  f := 2.881180799339505393;
  testrel(24, NE2, y, f, cnt,failed);

  y := jacobi_arcndx(10,1);
  f := 2.993222846126380898;
  testrel(25, NE, y, f, cnt,failed);

  k := 1-1/1024;
  y := jacobi_arcndx(1.0078125, k);
...
begin
  cnt := 0;
  failed := 0;
  writeln('Function: ','jacobi_arccdx');
  ...
  y := jacobi_arccdx(0.9990234375, k);
  f := 0.5102965534724259892e-1;
  testrel(2, NE, y, f, cnt,failed);

  y := jacobi_arccdx(0.75, k);
  f := 0.8140915468909887821;
  testrel(3, NE, y, f, cnt,failed);

  y := jacobi_arccdx(0.5,k);
  f := 1.156321727760690225;
  testrel(4, NE, y, f, cnt,failed);

  y := jacobi_arccdx(0.25,k);
  f := 1.432401697091115575;
  testrel(5, NE, y, f, cnt,failed);

  y := jacobi_arccdx(0.125,k);
  f := 1.560340614548334362;
  testrel(6, NE, y, f, cnt,failed);

  y := jacobi_arccdx(0.0078125, k);
  ...
  y := jacobi_arccdx(1.0009765625, k);
  f := 0.2550237905074735039e-1;
  testrel(14, NE, y, f, cnt,failed);

  y := jacobi_arccdx(1.5, k);
...
begin
  cnt := 0;
  failed := 0;
  writeln('Function: ','jacobi_arcdcx');

  k := 0.5;
  y := jacobi_arcdcx(1.0,0.5);
  f := 0.0;
  testrel(1, NE, y, f, cnt,failed);

  y := jacobi_arcdcx(1+1/1024,k);
  f := 0.05100475810149470078;
  testrel(2, NE, y, f, cnt,failed);

  y := jacobi_arcdcx(1.25,k);
  ...
  y := jacobi_arcdcx(10,k);
  f := 1.585541094196814353;
  testrel(5, NE, y, f, cnt,failed);

  y := jacobi_arcdcx(1e6,k);
  ...
  y := jacobi_arcdcx(1/128,k);
  f := 0.8389688777344191562;
  testrel(10, NE, y, f, cnt,failed);

  y := jacobi_arcdcx(0.0625,k);
  f := 0.8115997020324605835;
  testrel(11, NE, y, f, cnt,failed);

  y := jacobi_arcdcx(0.5,k);
  f := 0.5781608638803451126;
  testrel(12, NE, y, f, cnt,failed);

  y := jacobi_arcdcx(1-1/128,k);
  f := 0.07215342403220674891;
  testrel(13, NE, y, f, cnt,failed);

  y := jacobi_arcdcx(-0.75,k);
...
begin
  cnt := 0;
  failed := 0;
  writeln('Function: ','jacobi_arcsdx');
  ...
  y := jacobi_arcsdx(-0.0625,k);
  f := -0.06252038087319812021;
  testrel(2, NE, y, f, cnt,failed);

  y := jacobi_arcsdx(0.125,k);
  f := 0.1251639123384003270;
  testrel(3, NE, y, f, cnt,failed);

  y := jacobi_arcsdx(-0.25,k);
  f := -0.2513396906799018347;
  testrel(4, NE, y, f, cnt,failed);

  y := jacobi_arcsdx(0.5,k);
  f := 0.5117293103256968015;
  testrel(5, NE, y, f, cnt,failed);

  y := jacobi_arcsdx(-0.75,k);
...
begin
  cnt := 0;
  failed := 0;
  writeln('Function: ','jacobi_arcdsx');
  ...
  y := jacobi_arcdsx(1e-6, k);
  f := 0.8428748887311634267;
  testrel(8, NE, y, f, cnt,failed);

  y := jacobi_arcdsx(1/1024, k);
  f := 0.8425932681213084324;
  testrel(9, NE, y, f, cnt,failed);

  y := jacobi_arcdsx(0.5, k);
  f := 0.7018985502494669139;
  testrel(10, NE, y, f, cnt,failed);
