{Part 2a of regression test for SPECFUN unit  (c) 2010  W.Ehrhardt}
...
begin
  ...
  testrel(53, NE, cn, cf, cnt,failed);
...
begin
  ...
  testrel( 7,  5, y, f, cnt,failed);  {!!!!!!! 0.7 is inexact}
  ...
  testrel( 9, 25, y, f, cnt,failed);  {!!!!!!! 0.9 is inexact}
...
begin
  ...
  testabs(33, NA1, sl, f, cnt,failed);
  testabs(34, NA1, cl, g, cnt,failed);
