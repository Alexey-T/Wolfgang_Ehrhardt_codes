{Part 3a of regression test for SPECFUN unit  (c) 2010-2014  W.Ehrhardt}
...
begin
  ...
  y := cauchy_inv(a, b, ldexp(1,-20));
  f := -667539.2144281116036;
  testrel( 1, NE, y, f, cnt,failed);

  y := cauchy_inv(a, b, ldexp(1,-10));
...
begin
  ...
  y := chi2_inv(nu, 1-ldexp(1,-20)); {0.99999904632568359375}
...
begin
  ...
  testrel(56, 3*NE, y, f, cnt,failed);   {!!!!!}
...
begin
  ...
  y := exp_inv(a, alpha, 1-ldexp(1,-20));
