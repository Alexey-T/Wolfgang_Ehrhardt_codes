...
begin
  ...
  f := 1e4800;
  testrel(58, NE3, y, f, cnt,failed);

  y := LerchPhix(-1, 16, 1e300);
  f := 0.5e-4800;
  testrel(59, NE3, y, f, cnt,failed);
...
begin
  ...
  testrel(87, 200, y, f, cnt,failed);   {!!!!}

  y := polylogx(-16, -5);
  f := -20022.19871067531485;
  testrel(88, NE1, y, f, cnt,failed);
  ...
  testrel(101, NE2, y, f, cnt,failed);
  ...
  testrel(106, 640, y, f, cnt,failed);  {!!! Two Recursion levels, inexact square root, cancellation}
...
begin
  ...
  y := polylogrx(0.25, -1e12);
  f := -2.528432495403827337;
  testrel(47, NE, y, f, cnt,failed);

  y := polylogrx(0.25, -1e30);
  f := -3.180424185268321799;
  testrel(48, NE, y, f, cnt,failed);

  y := polylogrx(2.25, -1.125);
  ...
  y := polylogrx(100/3, -1e12);
  f := -0.8270096945443814986e12;
  testrel(57, NE, y, f, cnt,failed);

  y := polylogrx(100/3, -1e30);
  ...
  y := polylogrx(100/3, 100);
  f := 100.0000009241146676;
  testrel(69, NE, y, f, cnt,failed);

  y := polylogrx(-0.5, 1.125);
  ...
  {near s=1}
  y := polylogrx(1+1/512, 1.125);
  f := 2.084996235954538417;
  testrel(74, NE4, y, f, cnt,failed);

  y := polylogrx(1+1/512, 100);
  f := -4.603552137103300204;
  testrel(75, NE4, y, f, cnt,failed);

  y := polylogrx(1+1/512, 256);
  f := -5.554017619397917929;
  testrel(76, NE4, y, f, cnt,failed);
