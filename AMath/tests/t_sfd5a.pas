{Part 5a of regression test for SPECFUN unit  (c) 2010  W.Ehrhardt}
...
begin
  ...
  testrel( 3, NE, yr, fr, cnt,failed);
  testrel( 4, NE, yi, fi, cnt,failed);
...
begin
  ...
  y := toroidal_plm(l,m,1e19);
  f := 0.6523810244569567804e-8;
  testrel(7,NE,y,f,cnt,failed);

  y := toroidal_plm(l,m,2e19);
